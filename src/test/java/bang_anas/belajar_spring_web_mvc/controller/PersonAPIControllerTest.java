...
class PersonAPIControllerTest {
    ...
    void createPersonValidationError() throws Exception {
        ...
        // menerima semua data dari atribute milik CreatePersonRequest
        CreatePersonRequest request = new CreatePersonRequest();
//        request.setFirstName("Anas"); hilangkan agar error
        request.setMiddleName("Wiwok");
        request.setLastName("Nyueni");
//        request.setEmail("Alamak@yahoo.com"); hilangkan agar error
//        request.setPhone("901209310293"); hilangkan agar error
